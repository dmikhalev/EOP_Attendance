...
int EOP_Attendance_Service_delete_attendance(EOP_Attendance_Delete_attendance_request request);

int EOP_Attendance_Service_delete_student_attendance(EOP_Attendance_Delete_student_attendance_request request);

int EOP_Attendance_Service_delete_subject_attendance(EOP_Attendance_Delete_subject_attendance_request request);
